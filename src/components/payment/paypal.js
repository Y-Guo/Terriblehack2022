...
export default (description, cost, shipping) => {
  ...
  //       </div>
  //     </div>
  //   <script src="https://www.paypal.com/sdk/js?client-id=sb&enable-funding=venmo&currency=CAD" data-sdk-integration-source="button-factory" data-namespace="paypal_sdk"></script>
  //   <script>
